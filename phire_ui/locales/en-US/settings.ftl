...
item-aggressive-chart = Aggressive chart optimization
item-aggressive-chart-sub = Uses aggressive optimization strategy to improve performance, but may cause some charts to display incorrectly
item-aggressive-note = Aggressive note optimization
item-aggressive-note-sub = Uses aggressive optimization strategy to improve performance, but may cause some notes to disappear
item-aggressive-particle = Aggressive particle optimization
item-aggressive-particle-sub = Uses aggressive optimization strategy to improve performance, but may cause some particles to disappear
item-speed = Speed
