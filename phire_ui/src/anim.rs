use phire::core::{easing_from, StaticTween, TweenFunction, Tweenable};
use std::rc::Rc;
...
impl<T: Tweenable> Anim<T> {
    pub fn new(init: T) -> Self {
        Self {
            ...
            end_time: 1e-3,
            interpolator: StaticTween::get_rc(easing_from(phire::core::TweenMajor::Cubic, phire::core::TweenMinor::Out)),
        }
    }
